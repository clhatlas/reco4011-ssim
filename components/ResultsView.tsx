          ...
          <table className="w-full border-collapse text-sm border border-slate-300 table-fixed">
            <thead>
              <tr>
                ...
                <th className="p-2 border border-slate-300 bg-indigo-100 text-indigo-900 font-bold whitespace-nowrap text-center text-xs uppercase tracking-wider w-16 w-auto">
                    Driving Power
                </th>
              </tr>
            </thead>
